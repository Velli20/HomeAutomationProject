...
#define LIGHTS_NO_NAME								"(NIMETÖN)" 		/* List item text if light widget name is null or empty */

/* Window_temperature.c translations */
#define THERMOSTAT_WINDOW_TITLE						"Lämpötila"
#define THERMOSTAT_NO_NAME							"(NIMETÖN)"	    /* List item text if thermostat widget name is null or empty */
...
#define SETTINGS_MENU_ITEM_DATE						"Päivämäärä"
...
#define WINDOW_DATE_SETTINGS_WINDOW_TITLE 			"Aseta päivämäärä"
...
#define WINDOW_MENU_MENU_ITEM_TMEPERATURE			"Lämpötila"
...
#define WINDOW_ROOM_CONFIGURATION_WIDGET_NO_NAME    "(NIMETÖN)"
#define WINDOW_ROOM_CONFIGURATION_ROOM_NO_NAME      "(NIMETÖN)"
